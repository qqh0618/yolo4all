...
"")
        ...
        self.comboBox_mode = QtWidgets.QComboBox(self.groupBox_8)
        self.comboBox_mode.setMinimumSize(QtCore.QSize(0, 28))
        self.comboBox_mode.setStyleSheet("QComboBox QAbstractItemView {\n"
"font-family: \"Microsoft YaHei\";\n"
"font-size: 16px;\n"
"background:rgba(200, 200, 200,150);\n"
"selection-background-color: rgba(200, 200, 200,50);\n"
...
"")
    ...
    def retranslateUi(self, mainWindow):
        ...
        self.comboBox_mode.setItemText(0, _translate("mainWindow", "detect"))
        self.comboBox_mode.setItemText(1, _translate("mainWindow", "track"))
        self.comboBox_mode.setItemText(2, _translate("mainWindow", "seg"))
        self.comboBox_mode.setItemText(3, _translate("mainWindow", "cls"))
